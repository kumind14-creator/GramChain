...
function getSafeExample(exercise) {
  ...
  if (example?.sourceType !== "generated" && exampleUsesExactAnswer(example, exercise)) {
    return example;
  }

  // Generated local templates may preserve the form but still create an unnatural context.
  // Prefer a validated AI example; otherwise show no example rather than mislead learners.
  return null;
}
