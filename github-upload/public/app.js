...
async function loadExerciseSituation(exercise) {
  ...
  try {
    ...
    state.exerciseSituationStatus = response?.situationRu ? "ready" : "unavailable";
  } catch (error) {
...
function renderExerciseEnhanced() {
  ...
  const situation = state.exerciseContextKey === exerciseKey
    ? state.currentLanguage === "en" ? state.exerciseSituationEn : state.exerciseSituationRu
    : null;
  const situationTarget = state.exerciseContextKey === exerciseKey
    ? state.currentLanguage === "en" ? state.exerciseSituationTargetEn : state.exerciseSituationTargetRu
    : null;
