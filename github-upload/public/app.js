...
const TASK_TEXT = {
  ...
  task_2: {
    ...
    en: "Select at least two grammar patterns and complete one grammar chaining task."
  },
  task_3: {
    ...
    en: "Review the corrective feedback and the example sentence, then complete the next grammar chaining task."
  },
  task_4: {
    ru: "Завершите назначенную учебную сессию.",
    en: "Complete the assigned learning session."
  },
  task_5: {
...
async function startSelfExercise() {
  ...
  void startTask("task_4", getTaskText("task_4"), {
    selectedGrammarIds: state.selectedGrammarIds,
...
async function checkCurrentAnswer(answer) {
  ...
  if (
    ...
    void completeTask("task_4", getTaskText("task_4"), {
      totalExercises: state.currentSession?.totalExercises || 0
    });
  }
