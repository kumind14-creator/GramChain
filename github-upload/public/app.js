...
const TASK_TEXT = {
  ...
  task_3: {
    ru: "Посмотрите корректирующую обратную связь и пример предложения, затем выполните следующее задание на грамматическую цепочку.",
...
function ensureExerciseShownLogged(exercise) {
  ...
  if (shouldTrackFirstSelfExercise()) {
